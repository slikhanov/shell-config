...
export ZSH="/Users/slikhanov/.oh-my-zsh"
...
POWERLEVEL9K_LEFT_PROMPT_ELEMENTS=(root_indicator dir_writable dir)
...
POWERLEVEL9K_DIR_NON_WRITABLE_BACKGROUND='black'
POWERLEVEL9K_DIR_NON_WRITABLE_FOREGROUND='red'
